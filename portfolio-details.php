      ...
      <div class="breadcrumbs">
        <nav aria-label="breadcrumb">
          <ol class="breadcrumb">
            ...
            <li class="breadcrumb-item"><a href="index#portfolio">Portfolio</a></li>
          ...
          <div class="col-lg-6" data-aos="fade-left">
            <div class="portfolio-details-content">
              ...
              <div class="cta-buttons" data-aos="fade-up" data-aos-delay="400">
                ...
                <a href="index#portfolio" class="btn-next-project"> <i class="bi bi-arrow-left"></i> Back to Portfolio</a>
              </div>
            </div>
          </div>
        </div>
